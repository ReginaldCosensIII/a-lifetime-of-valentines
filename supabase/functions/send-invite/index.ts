          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div style="text-align: center; margin-top: 30px;">
                <a href="https://a-lifetime-of-valentines.vercel.app/register-partner?code=${invite_code}&email=${encodeURIComponent(partner_email)}&password=${temp_password}" class="btn">Accept Invite</a>
              </div>
            </div>
            <div class="footer">
